...
public partial class Adm_UploadEscritor : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (FileUpload1.PostedFile != null)
            {
                ...
                string diretorio = this.Server.MapPath("~\\Uploads\\ArquivosEscritor\\" + Util.Remove_Acento(nomearq));
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (RadioButtonList1.SelectedIndex > -1)
        {
            try
            {
                FileInfo arq = new FileInfo(Request.ServerVariables["APPL_PHYSICAL_PATH"] + @"\Uploads\ArquivosEscritor\" + RadioButtonList1.SelectedValue);
                if (arq.Exists)
                {
                    arq.Delete();
                    CarregaArquivos();
