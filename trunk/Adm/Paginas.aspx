<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Paginas.aspx.cs" Inherits="Adm_Paginas" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="container">
        <h2>
            <font color="#D9D9D7">Páginas Cadastradas</font></h2>
        <div align="right">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="pag_cod" DataNavigateUrlFormatString="~/Adm/CadPaginas.aspx?codpagina={0}"
                ...
                <asp:TemplateField HeaderText="TÍTULO">
                    ...
                    <ItemTemplate>
                        ...
                        &nbsp;-
                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="8pt" Text='<%# Bind("pag_menu") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Left" />
                </asp:TemplateField>
